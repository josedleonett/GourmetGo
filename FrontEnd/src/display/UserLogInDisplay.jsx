...
const UserLogInDisplay = () => {
  ...
  return (
    ...
    <Box component="form" onSubmit={handleSubmit} sx={{
        ...
        <Button variant="text" type="submit" sx={{ border: "1px solid black", borderRadius: "0px", padding: "1vw", width: "20vw", color: "black", '@media (max-width: 768px)': {width: '50%'}, }}>Log in</Button>
    </Box>
</Box>
  )
};
