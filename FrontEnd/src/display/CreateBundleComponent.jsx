    ...
    <div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
          ...
          <input type="file" onChange={(e) => setBundleImage(e.target.files[0])} required />
        </div>
        <div>
          <label>Gallery Images:</label>
          <input type="file" multiple onChange={(e) => setGalleryImages([...e.target.files])} required />
        </div>
        <div>
          <label>Starter:</label>
          <input type="text" value={starter} onChange={(e) => setStarter(e.target.value.split(','))} required />
        </div>
        <div>
          <label>Main Course:</label>
          <input type="text" value={mainCourse} onChange={(e) => setMainCourse(e.target.value.split(','))} required />
        </div>
        <div>
          <label>Desserts:</label>
          <input type="text" value={desserts} onChange={(e) => setDesserts(e.target.value.split(','))} required />
        </div>
        <div>
          <label>Drinks:</label>
          <input type="text" value={drinks} onChange={(e) => setDrinks(e.target.value.split(','))} required />
        </div>
        <div>
          <label>Categories:</label>
          <input type="text" value={categories} onChange={(e) => setCategories(e.target.value.split(','))} required />
        </div>
